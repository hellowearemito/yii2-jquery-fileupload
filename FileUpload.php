...
class FileUpload extends \yii\widgets\InputWidget
{
    ...
    {
        $view = $this->getView();
        assets\FileuploadAsset::register($view);
        if ($this->audioPreview) {
            assets\AudioPreviewAsset::register($view);
        }
        if ($this->imagePreview) {
            assets\ImagePreviewAsset::register($view);
        }
        if ($this->videoPreview) {
            assets\VideoPreviewAsset::register($view);
        }
    }
